...
extern "C" int ds4_gpu_hc_pre_norm_fused_tensor(
        ...
        ds4_gpu_tensor *flat, const ds4_gpu_tensor *hc,
        const void *model_map, uint64_t model_size,
        uint64_t fn_weight_offset, int fn_is_f16, uint64_t scale_offset,
    ...
    (void)out; (void)norm_out; (void)split; (void)mix; (void)flat; (void)hc;
    (void)model_map; (void)model_size; (void)fn_weight_offset; (void)fn_is_f16;
